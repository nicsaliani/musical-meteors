...
func spawn_asteroid(amount: int, pos: Vector2, size: Asteroid.SizeType):
	...
	# Update space available based on this asteroid's size
...
func _on_timer_timeout():
	...
	if pitches_available and sizes_available:
		spawn_asteroid(
			...
			randi_range(0, Asteroid.SizeType.size() - 1)
		)
